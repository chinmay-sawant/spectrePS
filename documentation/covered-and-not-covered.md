...
- Open a PDF and rasterize pages. Spectre's slice is path operators, text operators, the Flate, LZW, ASCII85, ASCIIHex, and RunLength stream filters with predictors 2 and 10 through 15, and image XObjects through `Do`, not PDF 1.7 or PDF 2.0.
